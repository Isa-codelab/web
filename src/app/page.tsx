  ...
  return (
    <main className="max-w-[1240px] mx-auto px-5 py-8 md:py-0">
      <div className="min-h-dvh flex flex-col gap-16 justify-center ">
          <div className="flex flex-col gap-8 itens-center md:items-start">
              <Image src={logo} alt="logo" width={108.5} height={30}/>

              <h1 className="text-4xl  texte-center loading-none font-heading font-medium flex flex-col md:text-7xl md:text-left">
          ...
          <div className="flex gap-5 items-stretch flex-col md:flex-row">
              <div className="flex-1 bg-gray-700 border border-gray-600 rouned-2xl p-8 space-y-6">
              ...
              <form className="bg-gray-700 border border-gray-600 rouned-2xl p-8 space-y-6 w-full md:max-w-[440px]" action="">
